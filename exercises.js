...
function Human(traits){
  ...
  this.cool = traits.cool;
    if (traits.cool === undefined)
      this.cool = false;
}

// Dog.prototype.status = function(doggie){
//   doggie.status = "normal";
// };
...
Human.prototype.pet = function(doggie){
  doggie.status = "happy";
};

Human.prototype.feed = function(doggie){
  doggie.hungry = false;
};
